...
function NavBar() {
  ...
  return (
    <nav
      className="navbar is-fixed-top is-primary has-text-black"
      role="navigation"
    ...
    >
      <div className="navbar-brand">
        <a
          ...
          role="button"
          className={`navbar-burger burger is-primary ${
            isActive ? "is-active" : ""
          }`}
          aria-label="menu"
          aria-expanded="false"
        ...
        <div className="navbar-end is-primary">
          <a href="https://github.com/matt-kukawski" alt="GitHub">
            <img
              ...
              src={require("images/projects/github-logo.png").default}
              alt="GitHub"
            />
          </a>
          <a href="https://www.linkedin.com/in/mattkukawski/" alt="LinkedIn">
            <img
              className="contact-icon"
              src={require("images/projects/linkedin-logo.png").default}
              alt="LinkedIn"
            />
          </a>
          <a
          ...
          >
            <img
              className="contact-icon"
              src={require("images/projects/email-logo.png").default}
              alt="Email"
            />
          </a>
        </div>
